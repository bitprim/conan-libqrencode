...
if __name__ == "__main__":
    ...
    builder.add_common_builds(shared_option_name="libqrencode:shared", pure_c=False)

    filtered_builds = []
    for settings, options, env_vars, build_requires in builder.builds:
        if (settings["build_type"] == "Release" or settings["build_type"] == "Debug") \
                and not options["libqrencode:shared"]:
...
#         reference=reference,
#         upload=upload,
#         remotes=upload,  # while redundant, this moves bitprim remote to position 0
